# less-module: nav-frontend-autocomplete-style

<!-- AUTO-GENERATED-CONTENT:START (INSTALL) -->
### Installering:
```
npm install nav-frontend-autocomplete-style --save
```
...
https://github.com/navikt/nav-frontend-moduler/tree/master/packages/node_modules/nav-frontend-autocomplete-style
<!-- AUTO-GENERATED-CONTENT:END *-->