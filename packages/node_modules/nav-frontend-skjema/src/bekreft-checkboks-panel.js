...
class BekreftCheckboksPanel extends React.Component {
    constructor(props) {
        ...
        if (this.props.children) {
            this.childrenId = nav_frontend_js_utils_1.guid();
        }
    }
    toggleOutline() {
    ...
    render() {
        ...
        return (React.createElement("div", { className: cls },
            ...
            React.createElement("label", { className: "inputPanel__label" },
                React.createElement("input", Object.assign({}, inputProps, { className: "inputPanel__field", type: "checkbox", checked: checked, "aria-checked": checked, onFocus: this.toggleOutline(), onBlur: this.toggleOutline(), onChange: onChange, "aria-labelledby": this.childrenId })),
